...
class IndexAction
{
    public function __invoke($date): array
    {
         ...
         * $device Форматируем коллекцию (сортируем, оставляем только неповторяющиеся, сортируем по филиалу, удаляем в статусе false
         ...
         * в toDayCount кладем разницу между двумя значениями
         * В переменную $summa кладем сумму коллекции по столбцу
         */
