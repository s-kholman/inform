    ...
    public function __invoke(MaxBotUser $maxBotUser)
    {
        ...
        $api->sendMessage(
            ...
            Бот не смог идентифицировать вас как сотрудника, необходимо зарегистрироваться на сайте https://inform.krimm.ru .
             При наличии регистрации нажмите кнопку "Отправить свой номер", администратор проверит данные и Вы получите доступ к функциям, при совпадении номера доступ будет открыт автоматически', // Текст сообщения, вы можете использовать HTML или Markdown
            [
