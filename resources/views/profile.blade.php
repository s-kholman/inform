        ...
        <div class="container">
            ...
            @elseif(!$user_reg)
                <div class="bg-light border rounded-3 p-3 text-center">
                    ...
                    <p>Это позволит администратору подвердить Вашу учетную запись как сотрудника ООО "Агрофирма "КРиММ"</p>
                </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="last_name" type="text" name="last_name" autofocus class="form-control @error('last_name') is-invalid @enderror"
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="first_name" type="text" class="form-control @error('last_name') is-invalid @enderror"   name="first_name"
                           @if(($user_reg && $user_reg->activation && $user_reg->infoFull) or ($user_reg && $user_reg->infoFull && !$user_reg->activation))
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    <input id="phone" type="text" placeholder="+7" class="form-control @error('phone') is-invalid @enderror"  name="phone"
                           @if(($user_reg && $user_reg->activation && $user_reg->infoFull) or ($user_reg && $user_reg->infoFull && !$user_reg->activation))
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    ...
                    <select for="filial_name" class="form-select @error('filial_name') is-invalid @enderror" name="filial_name">
                    ...
                    @enderror
                    @else
                        <input id="filial_name" type="text" readonly class="form-control" name="filial_name" value="{{\App\Models\filial::where('id',$user_reg->filial_id)->value('name')}}">
                    @endif
                </div>
            </div>
            ...
            <div class="row mb-3">
                ...
                <div class="col-md-6">
                    @if((!$user_reg) or ($user_reg && !$user_reg->infoFull && !$user_reg->activation))
                        <select for="post_name" class="form-select @error('post_name') is-invalid @enderror" name="post_name">
                    ...
                    @else
                        ...
                        <input id="post_name" type="text" readonly class="form-control" name="post_name" value="{{\App\Models\Post::where('id',$user_reg->post_id)->value('name')}}">
