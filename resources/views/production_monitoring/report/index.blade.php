                        ...
                        @forelse($arr_value as $filial_id => $item)
                            @if ($loop->first)
                                ...
                                <table class="table table-bordered text-center">
                                    <tr>
                                        <td colspan="11"><b>{{\App\Models\filial::where('id', $filial_id)->value('name')}}
                                                на
                                    ...
                                    <tr>
                                        ...
                                        <th rowspan="2" class="vertical-align"><label class="rotate">Контроль
                                                директор</label></th>
                                        <th rowspan="2" class="vertical-align"><label class="rotate">Контроль зам. ген.
                                                дир</label></th>
                                    </tr>
                                    <tr>
                                        <th class="vertical-align" style="background-color: #f3f9ff"><label class="rotate">Фаза
                                                хранения</label></th>
                                        <th class="vertical-align" style="background-color: #f3f9ff"><label class="rotate">Режим
                                                работы вентиляции</label></th>
                                        <th class="vertical-align" style="background-color: #f3f9ff"><label class="rotate">Температура
                                                хранения</label></th>
                                        <th class="vertical-align" style="background-color: #f3f9ff"><label class="rotate">Влажность
                                                хранения</label></th>
                                        <th class="vertical-align"><label class="rotate">Температура клубня</label>
                                        </td>
                                        ...
                                        <tr>
                                            ...
                                            <td style="background-color: #f3f9ff" class="text-nowrap">
                                                @forelse($value->Mode as $mode)
                                                    ...
                                                    - {{\Carbon\Carbon::parse($mode->timeDown)->format('H:i')}}; <br>
                                                @empty
                                                    н/д
                                                @endforelse
                                            </td>
