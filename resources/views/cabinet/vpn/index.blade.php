                ...
                <li class="list-group-item d-flex justify-content-between align-items-start">
                    <div class="ms-2 me-auto">
                        <div class="fw-bold">
                            ...
                            Некоторые антивирусы идентифицируют данный файл как угрозу, рекомендуется временно отключить антивирус!!!
                        </div>
                        Для выполнения первого файла необходимо нажать правой кнопки мыши и выбрать пункт <i>"Выполнить с помощью PowerShell"</i>.
